...
public class InvalidProcessorStateException extends Exception {
     ...
     */
    public InvalidProcessorStateException() {
    }
     ...
     *         unknown.)
     */
    public InvalidProcessorStateException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *         unknown.)
     */
    public InvalidProcessorStateException(Throwable cause) {
        super(cause);
    }
}
